...
bool interfaces__msg__node_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._node_status.NodeStatus", full_classname_dest, 38) == 0);
  }
  interfaces__msg__NodeStatus * ros_message = _ros_message;
  {  // node_status
    ...
    ros_message->node_status = (Py_True == field);
    Py_DECREF(field);
  }
  {  // node_list
    ...
    }
    {
      ...
      rosidl_runtime_c__String * dest = ros_message->node_list.data;
...
PyObject * interfaces__msg__node_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._node_status");
  ...
  {  // node_status
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->node_status ? 1 : 0);
    {
  ...
  {  // node_list
    ...
    rosidl_runtime_c__String * src = ros_message->node_list.data;
