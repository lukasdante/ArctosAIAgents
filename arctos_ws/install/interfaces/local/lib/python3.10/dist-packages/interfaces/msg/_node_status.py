...
class NodeStatus(metaclass=Metaclass_NodeStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.node_status = kwargs.get('node_status', bool())
    ...
    def node_status(self, value):
        if __debug__:
            assert \
                ...
                "The 'node_status' field must be of type 'bool'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'node_list' field must be a set or sequence and each value of type 'str'"
