...
class Recorder(BaseNode):
    def __init__(self):
        ...
        try:
            ...
            # MAKE SURE THE SILENCE_LIMIT HAS DECIMAL
            self.declare_parameter('silence_limit', 2.5, ParameterDescriptor(description='Silence length until audio recording terminates.'))
