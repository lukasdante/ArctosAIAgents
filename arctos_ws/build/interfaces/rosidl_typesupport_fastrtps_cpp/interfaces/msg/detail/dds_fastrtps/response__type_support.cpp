...
#include "interfaces/msg/detail/response__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::Response & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::Response & ros_message)
{
  // Member: response
  cdr >> ros_message.response;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::msg::Response *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::Response *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, Response)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_Response__handle;
}
