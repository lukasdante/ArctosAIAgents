...
#include "interfaces/msg/detail/node_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::NodeStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::NodeStatus & ros_message)
{
  // Member: node_status
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  // Member: node_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += padding +
        eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
        (ros_message.node_list[index].size() + 1);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::NodeStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::msg::NodeStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::NodeStatus *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_NodeStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, NodeStatus)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_NodeStatus__handle;
}
